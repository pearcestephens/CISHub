...
if (!Http::ensurePost() || !Http::ensureAuth() || !Http::rateLimit('transfer_close', 10)) { return; }

$in = json_decode(file_get_contents('php://input') ?: '[]', true) ?: $_POST;

$tid = isset($in['transfer_pk']) ? (int)$in['transfer_pk'] : 0;
$idk = isset($in['idempotency_key']) && $in['idempotency_key'] !== '' ? (string)$in['idempotency_key'] : "tr:$tid:close";
...
$jobId = Repo::addJob('close_transfer', $payload, $idk);
