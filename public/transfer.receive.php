...
if (!Http::ensurePost() || !Http::ensureAuth() || !Http::rateLimit('transfer_receive', 15)) { return; }
...
$idk   = isset($in['idempotency_key']) && $in['idempotency_key'] !== '' ? (string)$in['idempotency_key'] : "tr:$tid:recv:$ver";
